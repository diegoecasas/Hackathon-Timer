  ...
  return (
    <div className="max-w-3xl mx-auto p-4 sm:p-8 bg-gray-900 text-white rounded-3xl shadow-2xl border-2 border-teal-500/50">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-400 mt-2">Define el nombre y las etapas de tu hackathon.</p>
      </div>

      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
            <label htmlFor="eventName" className="block text-lg font-bold text-teal-300 mb-2">Nombre del Evento</label>
            <input
                id="eventName"
                type="text"
                value={eventName}
                onChange={(e) => setEventName(e.target.value)}
                placeholder="Ej: Hackathon de Innovación AI"
        ...
        <div className="space-y-4">
            <h2 className="text-lg font-bold text-teal-300">Fases del Evento</h2>
